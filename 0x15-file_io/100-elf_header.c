...
/**
 * print_magic - Then print the magic numbers of an ELF header.
 * @e_ident: pointer of an array of the ELF magic numbers.
 *
 ...
 * @e_ident: pointer of an array of the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 *   * @e_ident: pointer of an array of the ELF version.
 *    */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident: pointer fo an array of the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 *
 * Description: Closed file - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * Return: 0 (success)
 *
 * Description: If it is not ELF File or
 * fail function - exit code 98.
 */
